...
namespace BoxLib.Static
{
    public static class SecureStringReader
    {
        ...
        /// <param name="handler">The method to execute after the <see cref="string"/> was written in memory.
        /// The argument is the underlying <see cref="string"/> object of the <see cref="data"/>.</param>
        public static void Handle(this SecureString data, Action<string> handler) {
